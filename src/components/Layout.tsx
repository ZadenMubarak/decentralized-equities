...
export default function Layout({ children }: { children: React.ReactNode }) {  
  ...
  return (  
    <div className="min-h-screen bg-background flex">  
      ...
      <aside  
        className={cn(  
          "sticky top-0 left-0 h-screen w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-xl transition-transform duration-300 z-40 lg:relative lg:translate-x-0 ",  
          ...
          <div className="p-4 border-t border-slate-700 space-y-2">  
            {wallet ? (  
              <button   
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-gradient-to-r from-red-500 to-pink-600 text-white font-medium hover:shadow-lg hover:shadow-red-500/30 transition-all duration-200"  
              >  
                <Wallet size={20} />  
              ...
              <button   
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium hover:shadow-lg hover:shadow-green-500/30 transition-all duration-200"  
              >  
                <Wallet size={20} />  
                Connect Wallet  
              </button>  
            ...
            <div className="flex-1 flex justify-end items-center gap-4">  
              <div className="text-right">  
                ...
                <p className="text-xs text-muted-foreground">  
                  {wallet ? `${wallet.address.slice(0, 6)}...${wallet.address.slice(-4)}` : '0x742d...43B2'}  
                </p>  
              </div>  
